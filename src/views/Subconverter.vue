...
export default {
  data() {
    return {
      ...
      options: {
        ...
        shortTypes: {
          "url.mysscloud.top": "https://url.mysscloud.top/short",
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center;font-size:15px"><strong><span style="font-size:20px;color:red">haha</span></strong></br><strong><span style="font-size:20px">z</span><span><a href="z" target="_blank" style="color:red;font-size:20px;text-decoration:none">z</a></span></strong></br><strong><span style="font-size:20px">z（<span style="color:blue">z</span>）：</span><span><a href="z" style="color:red;font-size:20px;text-decoration:none">z</a></span></strong></br><strong><span style="font-size:20px">asdf（<span style="color:blue">z</span>）：</span><span><a href="htasf" style="color:red;font-size:20px;text-decoration:none">z</a></span></strong></br><strong><span style="font-size:20px">1z</span><span><a href="z" target="_blank" style="color:red;font-size:20px;text-decoration:none">z</a></span></strong></br>z</br></div>`, 'z', {
